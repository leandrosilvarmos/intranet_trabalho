...
<%
    ...
    objListaPresenca.fAtualizaAvEficacia vNumeroLista, vTreinamentoEficaz, vNomeAvaliador, vDataValidacao, vComoAvaliou, vCampoComplementar

    objListaPresenca.fAtualizaStatusAvEficacia vNumeroLista, "Av Eficacia corrigida pelo solicitante"
...
<%
	...
	objEmail.pTitulo = "AVISO - Avaliação de eficácia CORRIGIDA"

    MyBody = "Sistemas Interno HESAP - Lista de Presença"	 & vbcrlf & vbcrlf  & vbcrlf	
	MyBody = MyBody & "Há uma avaliação de eficácia CORRIGIDA e está PENDENTE para aprovação" & vbcrlf & vbcrlf
    ...
    MyBody = MyBody & "Clique no link para acessar essa lavaliação de eficácia " & vbcrlf 
