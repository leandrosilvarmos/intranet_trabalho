...
<body class="colunas">
    <div id="tudo">
        ...
        <section>
            <div id="conteudo">
                <img src="/_images/_sistemas/sistema_rh/lista_presenca/frase_analise.jpg" width="199" height="37" />
                <form name="tipo_avaliacao" method="post" action="analise_completa.asp">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size: 12px;" class="formulario_off">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <input class="form-control" name="titulo_evento" type="text" value="<%=ucase(objListaPresenca.TituloEvento)%>" size="75" readonly="readonly" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <span><%=objListaPresenca.TempoMedioDesInd%></span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <span><%=objListaPresenca.NmMinistrante%></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="6" style="height: 10px;">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td colspan="5" style="height: 35px;">
                                    <span><%=objListaPresenca.Objetivo%></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="6" style="height: 10px;">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td colspan="5" style="height: 35px;">
                                    <span><%=objListaPresenca.Impacto%></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="6" style="height: 10px;">&nbsp;</td>
                            ...
                            <tr>
                                <td style="text-align: right; padding-right: 5px;">Como identificará o resultado esperado?</td>
                                <td colspan="5" style="height: 35px;">
                                    <span><%=objListaPresenca.ValidarTreinamentoComo%></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="6" style="height: 10px;">&nbsp;</td>
                            ...
                            <tr>
                                <td style="text-align: right; padding-right: 5px;" valign="top">Quem validará o treinamento?</td>
                                <td colspan="5" align="left" valign="top">
                                    <span><%=objListaPresenca.AvaliadoPor%></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="6" style="height: 10px;">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td colspan="5" align="left" valign="top">
                                    <span><%=objListaPresenca.PrazoAvaliacao%></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="6" style="height: 10px;">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td colspan="5" align="left" valign="top">
                                    <select class="form-control" name="analista_lista">
                                        <option value="<%=objListaPresenca.Analista%>"><%=objListaPresenca.Analista%></option>
                            ...
                            <tr>
                                <td colspan="6">
                                    <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                        <tbody>
                                            <tr>
                                                <td width="30%" style="text-align: right; padding-right: 5px;" valign="top">Resultado:</td>
                                                <td width="15%" align="left" valign="top">
                                                    <select class="form-control" name="resultado_lista" id="resultado" onchange="show()">
                                                        <option value="<%=objListaPresenca.Resultado%>"><%=objListaPresenca.Resultado%></option>
                                                ...
                                                <td width="55%">
                                                    <div style="display: none;" id="campo">
                                                        <span style="float: right;">
                                                            Motivo:&nbsp;&nbsp;
                                                            <textarea name="motivo_lista" class="form-control" id="motivo" style="color: #000; float: right; width: 290px;"></textarea>
                                                        </span>
                            ...
                            <tr style="display: none;">
                                <td style="text-align: right; padding-right: 5px;" valign="top">Finalizado?</td>
                                <td width="40%" align="left" valign="top">
                                    <label style="font-weight: 500;">
                                        <input type="radio" name="analise_finalizada" value="Sim" style="border: none" />
                                        &nbsp;Sim
                                    </label>
                                    &nbsp;
                                    <label style="font-weight: 500;">
                                        <input type="radio" name="analise_finalizada" value="Nao" style="border: none" checked="checked" />
                                        &nbsp;Não
                                    </label>
                                </td>
                            </tr>
                    ...
                    <table width="300" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tbody>
                            <tr>
                                <td align="center">
                                    <a href="analise.asp">
                                        <img src="/_images/icon_back.png" border="0" alt="VOLTAR PARA PENDÊNCIAS" />
                                    </a>
                                    <br />
                                    Voltar
                                </td>
                                <td align="center">
                                    <a href="javascript:void(0)" onclick="valida();">
                                        <img src="/_images/icon_save.png" border="0" alt="EFETUAR MODIFICAÇÕES" />
                                    </a>
                                    <br />
                                    Atualizar 
                                </td>
