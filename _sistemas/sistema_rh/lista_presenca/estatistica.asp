                ...
                <form name="relatorio" action="estatistica_resultado.asp" method="post">
                    <table width="40%" border="0" cellspacing="0" cellpadding="0" style="border: solid 1px #333" align="center">
                        ...
                        <tr>
                            <td class="L1">
                                <p>
                                    <label style="margin-left: 20px; margin-top: 10px; margin-bottom: 0px;">Tipo de avaliação:</label>
                                </p>
                                <p>
                        ...
                        <tr>
                            <td >
                                ...
                                <p>
                                    <select name="tp_treinamento" class="form-control" style="margin-left: 40px; width: 254px;">
                                        <option value="">GERAL</option>
                                        <option value="C">COMPORTAMENTAL</option>
