...
<body class="colunas">
    <div id="tudo">
        ...
        <section>
            <div id="conteudo">
                <img src="/_images/_sistemas/sistema_rh/lista_presenca/frase_finalizados.jpg" width="320" height="37" />
                <br />
                <br />
                <table id="tbFinalizadas" class="table-hover table-bordered table-striped" width="100%" border="0" cellspacing="0" cellpadding="0" style="font: Tahoma, Geneva, sans-serif; font-size: 11px;">
                    <thead>
                        <tr>
                            <th width="5%"><span class="style1">Nº</span></th>
                            <th width="20%"><span class="style1">SOLICITANTE</span></th>
                            <th width="20%"><span class="style1">TÍTULO EVENTO</span></th>
                            <th width="15%" align="center"><span class="style1">DATA EVENTO</span></th>
                            <th width="15%" align="center"><span class="style1">ANALISTA</span></th>
                            <th width="8%" align="center"><span class="style1">STATUS</span></th>
                            <th width="6%" align="center"><span class="style1">VER</span></th>
                            <th width="6%" align="center"><span class="style1">PRINT<br />
                                LISTA</span></th>
                            <th width="5%" align="center"><span class="style1">PRINT<br />
                                AV EFICÁCIA </span></th>
                        </tr>
                    </thead>
                    <tbody>
                        <%
                            objListaPresenca.fListasFinalizadas
                        %>
                    </tbody>
                </table>
    ...
    <script type="text/javascript">
        ...
        function VisualizarLista(pNrLista){
            window.location.href='analise_av_finalizada.asp?lista='+pNrLista;
        }
