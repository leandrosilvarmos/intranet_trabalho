...
// ---- Common Options ----
var gMonths=["Janeiro","Fevereiro","Marco","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"];
...
var gsOutOfRange="Desculpe, mas essa Data esta muito longe!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gcCalBG="#a2ce48";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#6cae61";	// the background color of the inner table, showing as a frame.
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"Você não pode escolher esta data!\");return false;' onmouseover='return true;' >Hoje :"+gToday[2]+" de  "+gMonths[gToday[1]-1]+"  "+gToday[0]+"</A>";	// the content of the bottom section.
...
var gcCellBG="#789972";	// default background color of the cells. Use "" for transparent!!!
...
var gcSatBG="#167107";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#167107";	// Sunday background color
