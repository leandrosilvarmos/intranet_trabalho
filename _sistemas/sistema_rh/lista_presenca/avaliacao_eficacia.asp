...
<body class="colunas">
    <div id="tudo">
        ...
        <section>
            ...
            <div id="conteudo">
                <form name="tipo_avaliacao" method="post" action="av_eficacia_insere.asp">
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="1" style="font-size: 12px;" class="formulario">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="nome_avaliador" class="form-control" style="width: 392px;" type="text" size="50" maxlength="50" onkeypress="uppercase()" /></td>
                        </tr>
                        <tr>
                            ...
                            <td style="padding-bottom: 5px; padding-top: 5px;"><span style="height: 35px;">
                                <textarea name="como_avaliou" class="form-control" cols="75" rows="5"  style="width: 392px; height: 65px;" onkeypress="uppercase()"></textarea>
                            </span></td>
                        </tr>
                        <tr id="dt_inicio1">
                            ...
                            <td colspan="2" style="padding-bottom: 5px; padding-top: 5px;"><a href="javascript:void(0)" class="input-data">
                                <input type="text" name="data_validacao" id="data_validacao" class="form-control"  style="width: 70px; height: 13px;  float: left; margin-right: 5px;" size="9" maxlength="10" readonly="readonly" value="<%=Date()%>" />
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="padding-top: 5px;">
                                <textarea name="campo_complementar" class="form-control" style="width: 392px; height: 130px;" cols="75" rows="10" onkeypress="uppercase()"></textarea></td>
                        </tr>
                    </table>
                    <br />
                    <br />
