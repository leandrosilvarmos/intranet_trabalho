...
<%
    ...
    objListaPresenca.fAtualizaEmailFuncionario vChapa, vEmail
%>
    ...
    <div id="tudo">
        ...
        <section>
            <div id="conteudo">
                ...
                <br />
                <br />
                <p align="center" style="font-size: 18px">E-mail de colaborador alterado com sucesso. </p>
                <br />
                <p align="center">&nbsp;</p>
