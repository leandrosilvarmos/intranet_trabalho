...
<%
    ...
    Dim canceladas
    canceladas = objListaPresenca.fListasCanceladas
%>
...
<body class="colunas">
    <div id="tudo">
                    ...
                    <tbody>
                        <tr valign="top">
                            <td align="center">
                                ...
                                <br />
                                <br />
                                <img src="/_images/_sistemas/sistema_rh/lista_presenca/finalizadas.jpg" width="112" height="146" /></p></td>
                        </tr>
                    </tbody>
                </table>
        ...
        <section>
            ...
            <div id="conteudo">
                <img src="/_images/_sistemas/sistema_rh/lista_presenca/frase_canceladas.jpg" width="182" height="37" />
                <br />
                <br />
                <table id="tbCanceladas" class="table-hover table-bordered table-striped" width="100%" border="0" cellspacing="0" cellpadding="0" style="font: Tahoma, Geneva, sans-serif; font-size: 11px;">
                    <thead>
                        <tr>
                            <th width="5%"><strong>Nº</strong></th>
                            <th width="25%"><strong>SOLICITANTE</strong></th>
                            <th width="20%"><strong>TÍTULO EVENTO</strong></th>
                            <th width="15%" align="center"><strong>DATA EVENTO</strong></th>
                            <th width="15%" align="center"><strong>ANALISTA</strong></th>
