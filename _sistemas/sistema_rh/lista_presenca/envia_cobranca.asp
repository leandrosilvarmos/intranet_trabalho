...
<%
    Dim vNrLista, vNmSolicitante, vTituloEvento
...
<%
    ...
    'Atualiza campo de envio ENVIO_NOTIFICACAO_RH com a data atual
    objListaPresenca.fGravaEnvioNotificacaoRH vNrLista
...
<%
	...
	objEmail.pTitulo = "Notificação RH – Lista de Presença Atrasada"

    MyBody = "Sistemas Interno HESAP - Lista de Presença " & vbcrlf & vbcrlf & vbcrlf	
	MyBody = MyBody & "O prazo para devolução da lista de presença nro: "&vNrLista&" - "&vTituloEvento&" está vencido. Favor verificar e encaminhar ao RH – Treinamento." & vbcrlf & vbcrlf
    ...
    <div id="tudo">
        ...
        <section>
            <div id="conteudo">
                ...
                <br />
                <br />
                <p align="center" style="font-size: 18px">O e-mail de cobrança foi enviado com sucesso ao solicitante da lista.</p>
                <br />
