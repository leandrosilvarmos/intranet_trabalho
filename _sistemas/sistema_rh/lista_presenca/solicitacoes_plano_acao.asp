...
<%
    ...
    Dim vCdPlanoAcao, vTipoAvaliacao, vSolicitante, vSecao, vTituloEvento, vDemanda, vComo, vQuem, vPrazo

    vCdPlanoAcao   = Request("CdPlanoAcao")
    vTipoAvaliacao = Request("TipoAvaliacao")
    vSolicitante   = Request("Solicitante")
    vSecao	       = Request("Secao")
    vTituloEvento  = Request("Titulo")
    vDemanda       = Request("Demanda")
    vComo          = Request("Como")
    vQuem          = Request("Quem")
    vPrazo         = Request("Prazo")
%>
...
<body class="colunas">
    <div id="tudo">
        ...
        <section>
            <div id="conteudo">
                ...
                <form name="tipo_avaliacao" method="post" action="solicitacao_completa.asp" onsubmit="return validar();	">
                    <input name="plano_acao" type="hidden" value="<%=vCdPlanoAcao%>" />
                    <table width="100%" border="0" cellspacing="1" cellpadding="1" style="font-size: 12px;" class="formulario">
                        <tbody>
                            <tr>
                                ...
                                <td colspan="2">
                                    <select name="avaliacao" class="form-control" style="width: 430px;" onchange="ajuda(); desbilita_campos();">
                                        <option selected="selected" value="<%=vTipoAvaliacao%>"><%=vTipoAvaliacao%></option>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <select id="nome_solicitante" name="nome_solicitante" class="form-control" style="width: 430px;">
                                        <option selected="selected" value="<%=vSolicitante%>"><%=vSolicitante%></option>
                                        <%
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" name="titulo_evento" class="form-control" style="width: 430px;" size="75" maxlength="255" onkeypress="uppercase()" value="<%=vTituloEvento%>" />
                            ...
                            <tr class="dados_lista">
                                ...
                                <td>
                                    <label style="font-weight: 500;">
                                        <input type="radio" name="tp_treinamento" value="C" style="border: none"/>
                                        Comportamental
                                    </label>
                                    <label style="font-weight: 500;">
                                        <input type="radio" name="tp_treinamento" value="T" style="border: none" />
                                        Técnico
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="52%">
                                    <select id="setor" name="setor" class="form-control" style="width: 430px;">
                                        <option value="<%=vSecao%>"><%=vSecao%></option>
                                        <%
                            ...
                            <tr>
                                ...
                                <td>
                                    <label style="font-weight: 500;">
                                        <input type="radio" name="setor_enfermagem" value="Sim" style="border: none" />
                                        Sim
                                    </label>
                                    <label style="font-weight: 500;">
                                        <input type="radio" name="setor_enfermagem" value="Nao" style="border: none" />
                                        Não
                                    </label>
                                </td>
                            </tr>
                            ...
                            <tr id="dt_inicio2" style="display: none">
                            ...
                            <tr id="linha3" style="display: none;">
                                <td colspan="3" align="center">
                                    <hr style="border-color: #3291af" />
                                </td>
                            </tr>
                            <tr id="dt_inicio3" style="display: none">
                            ...
                            <tr id="linha4" style="display: none;">
                                <td colspan="3" align="center">
                                    <hr style="border-color: #3291af" />
                                </td>
                            </tr>
                            <tr id="dt_inicio4" style="display: none">
                            ...
                            <tr id="linha5" style="display: none;">
                                <td colspan="3" align="center">
                                    <hr style="border-color: #3291af" />
                                </td>
                            </tr>
                            <tr id="dt_inicio5" style="display: none">
                            ...
                            <tr id="linha6" style="display: none;">
                                <td colspan="3" align="center">
                                    <hr style="border-color: #3291af" />
                                </td>
                            </tr>
                            <tr id="dt_inicio6" style="display: none">
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" style="height: 35px; padding-top: 5px;">
                                    <textarea name="objetivo" cols="80" rows="8" class="form-control" style="width: 430px; overflow: auto" onkeypress="uppercase()"><%=vDemanda%></textarea>
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" style="height: 35px; padding-top: 5px;">
                                    <textarea name="impacto" cols="80" rows="8" class="form-control" style="width: 430px; overflow: auto" onkeypress="uppercase()"></textarea>
                                </td>
                                <td align="left" valign="top" style="height: 35px;">
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" style="padding-top: 5px;">
                                    <span style="height: 35px;">
                                        <textarea name="como" cols="80" rows="10" class="form-control" style="width: 430px; overflow: auto" onkeypress="uppercase()"><%=vComo%></textarea>
                                    </span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><span style="height: 35px;">
                                    <input name="validar_treinamento" type="text" class="form-control" style="width: 430px;" onkeypress="uppercase()" size="80" value='<%=vQuem%>'/>
                                </span></td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <a href="javascript:void(0)" class="input-data">
                                        <input type="text" name="prazo_eficacia" class="form-control" style="width: 75px; float: left;" size="9" value="<%=vPrazo%>" />
                    ...
                    <br />
                    <p align="right" style="font-size: 9px">* Tópicos devem ser separados por vírgula.</p>
                    <table width="30%" border="0" cellspacing="0" cellpadding="0" align="center" class="formulario" style="font-size: 11px">
                        <tbody>
                            <tr>
                                <td align="center" width="50%">
                                    <a href="solicitacoes.asp">
    ...
    <script type="text/javascript">
        ...
        function validar() {
            ...
            if (document.tipo_avaliacao.avaliacao.value != "REUNIÃO" && document.tipo_avaliacao.avaliacao.value != "PALESTRA / SIMPÓSIO / JORNADA") {
        ...
        function desbilita_campos() {
            if (document.tipo_avaliacao.avaliacao.value == "PALESTRA / SIMPÓSIO / JORNADA" || document.tipo_avaliacao.avaliacao.value == "REUNIÃO") {
