...
<%
    ...
    'Finaliza lista av eficacia
    objListaPresenca.fFinalizaListaAvEf vNrLista
    ...
    <div id="tudo">
        ...
        <section>
            <div id="conteudo">
                ...
                <br />
                <br />
                <p align="center" style="font-size: 18px">A  AVALIAÇÃO DE EFICÁCIA foi FINALIZADA com sucesso.</p>
                <br />
                <p align="center">&nbsp;</p>
